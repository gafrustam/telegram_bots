"""Unit tests for english_bot conversation logic."""
import sys
import os
import pytest
...
class TestConversationHistory:
    ...
    def test_message_structure(self):
        msg = {"role": "user", "content": "Can I have a coffee please?"}
        assert "role" in msg
...
class TestInputSanitization:
    ...
    def test_clean_input_passes(self):
        INJECTION_PATTERNS = ["ignore previous", "system:", "you are now", "disregard", "assistant:"]
        clean = "I would like to practice ordering food at a restaurant"
        lower = clean.lower()
